namespace UI
{
    ...
    {
        /**
         * Метод, що запитує користувача по кількість напоїв, які бажає замовити користувач.
         * Напої можуть бути різними. Не обов'язково одного типу.
         */
        public static void DrinksQuantityInOrder()
        {
            Console.WriteLine("Скiльки напоїв ви бажаєте замовити?");
        }
        /**
