namespace Product
{
    internal abstract class Drink
    {
        ...
        protected decimal priceOfIngredients;
        protected decimal priceOfCup;
        protected decimal priceOfSugar;
        protected decimal taxForIngredients;
        protected decimal taxForCup;
        protected decimal taxForSugar;
